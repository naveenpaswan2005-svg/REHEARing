...
export const HeroSection = () => {
    ...
    return (
        <section
            id="home"
            className="relative min-h-screen -mt-20 overflow-hidden bg-gradient-to-br from-background via-background to-purple-soft"
        >
            {/* Background Pattern */}
            <div className="absolute inset-0 opacity-30">
                <div className="absolute top-20 right-0 w-96 h-76 bg-primary/5 rounded-full blur-3xl" />
                    ...
                    >
                        ...
                        <div className="space-y-4">
                            ...
                            <p className="text-lg sm:text-xl text-muted-foreground max-w-xl leading-relaxed">
                                Experience world-class audiology care at
                                REHEARing. Our certified audiologists provide
                                personalized hearing solutions with premium
                                hearing aids from global brands.
                            </p>
                        </div>
