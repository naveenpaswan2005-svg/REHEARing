        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-white/70 leading-relaxed mb-6">
              REHEARing is Delhi's trusted hearing care clinic offering premium 
              hearing aids, expert audiology services, and compassionate patient care.
            </p>
            {/* Social Icons */}
      ...
      <div className="bg-black/20 py-5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 text-sm text-white/60">
            <p>© {new Date().getFullYear()} REHEARing – Hearing & Balance Clinic. All rights reserved.</p>
