...
const getProductImage = (type: string, brand: string) => {
    if (type.includes("CIC") || type.includes("IIC") || type.includes("ITC"))
        return cicImage;
            ...
            <div className="section-container">
                ...
                >
                    ...
                    <p className="section-subheading">
                        Explore our range of 18+ hearing aids from
                        world-renowned brands including Signia, Widex, Phonak &
                        ReSound.
                    </p>
                </motion.div>
                        ...
                        >
                            ...
                            <div className="p-5">
                                ...
                                <div className="flex flex-wrap gap-1.5 mb-4">
                                    ...
                                    {product.battery.includes("Li-ion") ||
                                    product.battery.includes("Rechargeable") ? (
